...
export const phoneNumbersAPI = {
  ...
  getPurchasedNumbers: async (): Promise<PurchasedNumber[]> => {
    const response = await axios.get<{ success: boolean; data: PurchasedNumber[] }>('/admin/phone-numbers/purchased');
  ...
  getAssignedNumbers: async (): Promise<AssignedPhoneNumber[]> => {
    const response = await axios.get<{ success: boolean; data: AssignedPhoneNumber[] }>('/admin/phone-numbers/assigned');
    return response.data.data;
  },
