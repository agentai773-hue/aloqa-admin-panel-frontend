      ...
      setFormData({
        ...
        synthesizerConfig: {
          ...
          provider_config: {
            ...
            // ElevenLabs fields
            stability: assistant.synthesizerConfig?.provider_config?.stability ?? 0.90,
            similarity_boost: assistant.synthesizerConfig?.provider_config?.similarity_boost ?? 0.75,
            speed: assistant.synthesizerConfig?.provider_config?.speed ?? 0.95,
            emotion: assistant.synthesizerConfig?.provider_config?.emotion ?? "friendly",
            emotion_strength: assistant.synthesizerConfig?.provider_config?.emotion_strength ?? 0.50,
            voice_pause_model: assistant.synthesizerConfig?.provider_config?.voice_pause_model ?? "minimal",
            auto_punctuation_pause: assistant.synthesizerConfig?.provider_config?.auto_punctuation_pause ?? true,
            dynamic_emotion_adaptation: assistant.synthesizerConfig?.provider_config?.dynamic_emotion_adaptation ?? false,
